...
- Controllers must remain thin; delegate business logic to service classes.
- All business logic must exist in `app/Services`.
- Database access must go through repository classes in `app/Repositories`.
